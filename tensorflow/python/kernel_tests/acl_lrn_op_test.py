...
class LRNOpTest(test.TestCase):
  ...
  def _RunAndVerify(self, dtype):
    with self.test_session(use_gpu=True):
      ...
      shape[3] += 1
      # p = constant_op.constant([], shape=shape)
      ...
      #params = {p : np.array([[ [[0, 1,2,3],[4,0, 5,6],[7,8,9, 0],[-1, 10,11,12]], [[13, 1, 14,15],[16,2, 17,18],[19,20,21, 3],[5, 22,23,24]] ],
      #                        [ [[25,26,27,199],[28,29,30,123],[31,32,33,44],[34,35,36,55]], [[37,38,39,66],[40,41,42,77],[43,44,45,33],[46,47,48, 100]] ]]).astype("f")}
