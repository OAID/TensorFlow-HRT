...
#if defined(TEST_ACL) && defined(USE_ACL)
    acl_avg_pooling_op_ = nullptr;
    if (std::is_same<T, float>::value)
      acl_avg_pooling_op_ = new AclAvgPoolingOp<Device, T>(context) ;
#endif
  }
...
#if defined(TEST_ACL) && defined(USE_ACL)
  AclAvgPoolingOp<Device, T>* acl_avg_pooling_op_;
#endif
};
