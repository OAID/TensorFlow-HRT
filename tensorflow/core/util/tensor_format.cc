...
#if defined(USE_ACL)
string AclGetConvnetDataFormatAttrString() {
  return "data_format: { 'NHWC', 'NCHW' } = 'NCHW' ";
}

string AclGetConvnetFilterFormatAttrString() {
  return "filter_format: { 'HWIO', 'OIHW' } = 'OIHW' ";
}
#endif
